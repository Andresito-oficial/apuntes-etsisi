...
public class MergeSort {
	...
	public MergeSort (List<Integer> input) {
		ToSort = input;
	...
	List<Integer> sorted () {
		...
		List<Integer> FirstHalf = new MergeSort(new ArrayList<>(ToSort.subList(0, (divider)))).sorted();
		List<Integer> SecondHalf = new MergeSort(new ArrayList<>(ToSort.subList(divider, ToSort.size()))).sorted();
